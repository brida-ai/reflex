---
name: brida-reflex-incoming-message-risk
description: "Implement and verify the Brida Reflex Incoming message risk use case: classify the semantic risk of an incoming non-sensitive message after deterministic transport, authentication, reputation and attachment checks have already run. Use when the user names incoming-message-risk, asks for this exact bounded decision, or wants to integrate/test the matching Reflex without a discovery interview. Triggers include: phishing, spam risk, inbound message risk."
---
