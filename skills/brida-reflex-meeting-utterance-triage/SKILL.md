---
name: brida-reflex-meeting-utterance-triage
description: "Implement and verify the Brida Reflex Meeting utterance triage use case: classify one already-segmented meeting utterance as an action item, decision, open question, risk, ordinary status/chatter, or ambiguous. Use when the user names meeting-utterance-triage, asks for this exact bounded decision, or wants to integrate/test the matching Reflex without a discovery interview. Triggers include: meeting action items, meeting minutes, live meeting notes, action item detection, meeting triage."
---
