# Semantic content blocking playbook

Canonical use-case ID: `semantic-content-blocking`
Version: `1`
...
classify a host-selected page/content candidate as ordinary content, promotional content, or ambiguous content after exact blocking rules have already run.

## Primary semantic question

Classify the supplied page/content candidate after deterministic blocklists and exact rules have already run. Judge only whether the candidate itself is ordinary content, materially promotional/advertising content, or ambiguous.
