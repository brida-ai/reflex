# Code change classification playbook

Canonical use-case ID: `code-change-classification`
Version: `1`
...
classify the primary semantic type of one bounded software change after deterministic Git, path and static-analysis checks.

## Primary semantic question

Classify the primary semantic type of the supplied bounded software change. Use only the supplied summary, component/path classes and deterministic signals; do not infer an unstated vulnerability or release impact.
