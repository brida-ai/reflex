---
name: brida-reflex-semantic-response-health
description: "Implement and verify the Brida Reflex Semantic response health use case: classify whether a transport-successful response confirms completion, semantically reports failure, or leaves the requested operation unresolved. Use when the user names semantic-response-health, asks for this exact bounded decision, or wants to integrate/test the matching Reflex without a discovery interview."
---
