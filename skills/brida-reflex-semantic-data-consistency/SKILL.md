---
name: brida-reflex-semantic-data-consistency
description: "Implement and verify the Brida Reflex Semantic data consistency use case: judge whether a structured record is semantically consistent after exact schema and invariant checks have already passed. Use when the user names semantic-data-consistency, asks for this exact bounded decision, or wants to integrate/test the matching Reflex without a discovery interview."
---
