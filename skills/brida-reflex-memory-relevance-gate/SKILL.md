---
name: brida-reflex-memory-relevance-gate
description: "Implement and verify the Brida Reflex Memory relevance gate use case: decide whether a non-sensitive observation has enough durable future utility to become a memory candidate. Use when the user names memory-relevance-gate, asks for this exact bounded decision, or wants to integrate/test the matching Reflex without a discovery interview. Triggers include: memory relevance, remember this, memory gate."
---
