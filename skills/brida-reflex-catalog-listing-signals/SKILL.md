---
name: brida-reflex-catalog-listing-signals
description: "Implement and verify the Brida Reflex Catalog listing signals use case: classify the primary kind of a bounded catalog listing while collecting independent quality and clarification signals over the same state. Use when the user names catalog-listing-signals, asks for this exact bounded decision, or wants to integrate/test the matching Reflex without a discovery interview."
---
