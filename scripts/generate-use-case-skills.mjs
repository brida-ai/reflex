...
const aliases = {
  ...
  'semantic-row-filter': ['semantic SQL', 'semantic filter', 'semantic grep', 'semantic predicate', 'semantic WHERE', 'natural language filter', 'natural language SQL filter', 'row relevance'],
